    ...
    try {
        ...
        if (type === 'auth-form') {
            ...
            editor.createShapes([
                ...
                { id: basicCardId, type: 'geo', x: center.x + 40, y: center.y + 40, props: { geo: 'rectangle', color: 'grey', fill: 'semi', w: 240, h: 420, text: 'Basic\n\n$0/mo\n\n- 기능 A\n- 기능 B' } },
            ...
            editor.createShapes([
                ...
                { id: item1BgId, type: 'geo', x: center.x + 20, y: center.y + 20, props: { geo: 'rectangle', color: 'grey', fill: 'none', w: 560, h: 120, align: 'start', text: '                콘텐츠 제목 1\n                여기에 설명이 들어갑니다...' } },
                { id: item1ImgId, type: 'geo', x: center.x + 40, y: center.y + 40, props: { geo: 'rectangle', color: 'grey', fill: 'solid', w: 80, h: 80 } },
                
                { id: item2BgId, type: 'geo', x: center.x + 20, y: center.y + 160, props: { geo: 'rectangle', color: 'grey', fill: 'none', w: 560, h: 120, align: 'start', text: '                콘텐츠 제목 2\n                여기에 설명이 들어갑니다...' } },
...
export const insertDiagramComponent = (editor: Editor, type: string) => {
    try {
        ...
        if (type === 'user-flow') {
            ...
            editor.createShapes([
                { id: rootId, type: 'geo', x: center.x + 200, y: center.y, props: { geo: 'rectangle', color: 'black', fill: 'solid', w: 160, h: 60, text: 'Home' } },
            ...
            editor.createShapes([
                { id: bgId, type: 'geo', x: center.x, y: center.y, props: { geo: 'rectangle', color: 'grey', fill: 'none', w: 500, h: 400, text: 'Idea Board', align: 'start', verticalAlign: 'start' } },
                { id: s1, type: 'geo', x: center.x + 40, y: center.y + 60, rotation: -0.1, props: { geo: 'rectangle', color: 'yellow', fill: 'solid', w: 120, h: 120, text: 'Idea 1' } },
                { id: s2, type: 'geo', x: center.x + 200, y: center.y + 40, rotation: 0.05, props: { geo: 'rectangle', color: 'green', fill: 'solid', w: 120, h: 120, text: 'Idea 2' } },
                { id: s3, type: 'geo', x: center.x + 340, y: center.y + 80, rotation: -0.05, props: { geo: 'rectangle', color: 'blue', fill: 'solid', w: 120, h: 120, text: 'Idea 3' } },
